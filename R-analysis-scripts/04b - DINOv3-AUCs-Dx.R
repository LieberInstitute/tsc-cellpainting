...
write.csv(AUC,file="caret_Dx_Normoxia_allLines_DINOv3.csv")
...
write.csv(AUC_F,file="caret_Dx_Normoxia_Females_DINOv3.csv")
...
write.csv(AUC_M,file="caret_Dx_Normoxia_Males_DINOv3.csv")
...
write.csv(AUC_F,file="caret_Dx_Normoxia_Females_DINOv3_shuffled.csv")
...
write.csv(AUC,file="caret_Dx_Hypoxia_allLines_DINOv3.csv")
...
write.csv(AUC_F,file="caret_Dx_Hypoxia_Females_DINOv3.csv")
...
write.csv(AUC_M,file="caret_Dx_Hypoxia_Males_DINOv3.csv")