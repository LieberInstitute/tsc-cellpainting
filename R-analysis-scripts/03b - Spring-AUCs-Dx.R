...
#Full dataset
trainingDx <- features_normoxia[,-c(1:4,6:10)]
...
write.csv(AUC,file="caret_Dx_Normoxia_allLines_Spring.csv")

trainingDxF <- featuresNormoxiaF[,-c(1:4,6:10)]
trainingDxM <- featuresNormoxiaM[,-c(1:4,6:10)]
...
write.csv(AUC_F,file="caret_Dx_Normoxia_Females_Spring.csv")
...
write.csv(AUC_M,file="caret_Dx_Normoxia_Males_Spring.csv")
...
write.csv(AUC_F,file="caret_Dx_Normoxia_Females_Spring_shuffled.csv")
...
#Full dataset
trainingDx <- features_hypoxia[,-c(1:4,6:10)]
...
write.csv(AUC,file="caret_Dx_Hypoxia_allLines_Spring.csv")

trainingDxF <- featuresHypoxiaF[,-c(1:4,6:10)]
trainingDxM <- featuresHypoxiaM[,-c(1:4,6:10)]
...
write.csv(AUC_F,file="caret_Dx_Hypoxia_Females_Spring.csv")
...
write.csv(AUC_M,file="caret_Dx_Hypoxia_Males_Spring.csv")